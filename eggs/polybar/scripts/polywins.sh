...
ignore_windows="polybar:yad:kittyd:telegram-desktop:TelegramDesktop:Plank" # :-separated list of windows we want to ignore (bars, desktop managers, etc.)
